...
class TestMultiRegistrarPricing:
    ...
    async def test_multi_registrar_pricing_all_enabled(self, monkeypatch):
        ...
        with patch("domainidom.services.pricing.get_namecom_price") as mock_namecom, \
            ...
            mock_namecheap.return_value = RegistrarPrice("namecheap", None, error="pricing_unavailable")
